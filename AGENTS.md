...
- Put user-facing strings in resources. When adding or changing copy, update the base file and all 15 localized `values-*` `strings.xml` files unless the user narrows the scope.
