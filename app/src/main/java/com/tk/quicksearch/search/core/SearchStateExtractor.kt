...
internal object SearchStateExtractor {
    fun extractResultsState(s: SearchUiState) =
        SearchResultsState(
            ...
            reminderResults = s.reminderResults,
            pinnedReminders = s.pinnedReminders,
            ...
            remindersSectionState = s.remindersSectionState,
            ...
            isWorldClockAliasMode = s.isWorldClockAliasMode,
            isDictionaryAliasMode = s.isDictionaryAliasMode,
            isWeatherAliasMode = s.isWeatherAliasMode,
    ...
    fun extractFeatureState(s: SearchUiState) =
        SearchFeatureState(
            ...
            isSavingGeminiApiKey = s.isSavingGeminiApiKey,
            ...
            weatherLocationConfigured = s.weatherLocationConfigured,
    ...
    fun extractConfigState(s: SearchUiState) =
        SearchUiConfigState(
            ...
            accentColorMode = s.accentColorMode,
            customAccentColorArgb = s.customAccentColorArgb,
