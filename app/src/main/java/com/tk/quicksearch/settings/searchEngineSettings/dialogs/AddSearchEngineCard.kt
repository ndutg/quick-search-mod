...
import com.tk.quicksearch.searchEngines.CUSTOM_QUERY_PLACEHOLDER
...
@Composable
private fun AddSearchEngineForm(
    ...
    Column(
        ...
        Column(
            modifier =
                if (requestInitialFocus) {
                    formContentModifier.verticalScroll(scrollState)
                } else {
                    formContentModifier
                },
