...
data class SettingsScreenCallbacks(
    ...
    val onToggleSettingsIcon: (Boolean) -> Unit,
    ...
    val onSetWorldClockAlias: (String) -> Unit,
    ...
    val onToggleColorVisualizer: (Boolean) -> Unit,
    ...
    val appearance: AppearanceSettingsCallbacks
        get() =
            AppearanceSettingsCallbacks(
                ...
                onToggleSettingsIcon = onToggleSettingsIcon,
