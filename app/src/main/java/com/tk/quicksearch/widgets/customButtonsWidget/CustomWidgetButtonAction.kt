...
enum class CustomWidgetButtonType(
    val value: String,
) {
    APP("app"),
    CONTACT("contact"),
...
sealed class CustomWidgetButtonAction : Parcelable {
    ...
    data class Setting(
        ...
        fun toDeviceSetting(): DeviceSetting =
            DeviceSetting(
                id = id,
                title = title,
    ...
    data class AppShortcut(
        ...
        fun toStaticShortcut(): StaticShortcut =
            StaticShortcut(
                packageName = packageName,
                appLabel = appLabel,
                id = id,
                ...
                val action: CustomWidgetButtonAction? = when (json.optString(KEY_TYPE)) {
                    ...
                    CustomWidgetButtonType.CONTACT.value -> {
                        ...
                        Contact(
                            ...
                            displayName =
                                json
                                    .optString(KEY_DISPLAY_NAME, lookupKey)
                                    .nullIfBlankOrLiteralNull()
                                    ?: lookupKey,
                    ...
                    CustomWidgetButtonType.FILE.value -> {
                        ...
                        File(
                            ...
                            displayName =
                                json
                                    .optString(KEY_DISPLAY_NAME, uri)
                                    .nullIfBlankOrLiteralNull()
                                    ?: uri,
                    ...
                    CustomWidgetButtonType.APP_SHORTCUT.value -> {
                        ...
                        AppShortcut(
                            ...
                            appLabel =
                                json
                                    .optString(KEY_APP_LABEL, packageName)
                                    .nullIfBlankOrLiteralNull()
                                    ?: packageName,
                            id = id,
...
private fun jsonToSettingExtras(array: JSONArray?): List<SettingExtra> {
    ...
    for (index in 0 until array.length()) {
        ...
        val type =
            when (item.optString(KEY_EXTRA_TYPE)) {
